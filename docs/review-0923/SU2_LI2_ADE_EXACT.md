...
> **第二轮更新**：本文第 5–6 节所说"2O/2I 的全部进一步化简尚未完成"已由[极对偶精确公式](SU2_POLAR_DUAL_EXACT.md) 完成：全部 659 类都有不含 Li₂ 的精确闭式，退化输入保持原锥点化为初等函数，D 表对任意 n 已证。本文的 Li₂ 主公式本身保持有效。
